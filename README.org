...
* Installation
The default fonts are provided in the =dist/fonts= folder. They cover the 80-column xterm master set; scaled sizes and 132-column variants are opt-in generator outputs.
...
# Optional: regenerate every base size/width before conversion.

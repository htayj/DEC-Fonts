.PHONY: help bdf convert fonts check package ci package-deb package-rpm package-arch distro-packages aur-srcinfo nix-metadata nix-check test-deb-package test-rpm-package test-arch-package test-nix-flake-container test-distro-packages clean-release clean-packages
